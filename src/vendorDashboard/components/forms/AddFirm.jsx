...
const handleCategoryChange = (event)=>{
  ...
  return (
    ...
    {loading && <div className="loaderSection" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <ThreeCircles
          visible={loading}
          height={100}
          width={100}
          ...
          wrapperClass=""
        />
         <p style={{ marginTop: '10px', textAlign: 'center' }}>Firm is being added... Please wait</p>
      </div>}
        ...
        <h3>Add Firm</h3>
            ...
            <div className="checkInp">
              ...
              <div className="inputsContainer">
                ...
                <label>Veg</label>
<input type="checkbox" checked ={category.includes('veg')}  value="veg" onChange={handleCategoryChange}/>              </div>
              <div className="checkboxContainer">
                <label>Non-Veg</label>
